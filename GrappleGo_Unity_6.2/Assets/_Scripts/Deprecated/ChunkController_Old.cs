...
public class ChunkController_Old : MonoBehaviour
{
    ...
    public IObjectPool<ChunkController_Old> Pool { get; set; }
    ...
    //    _detecterRef._steppedOn = false;
        
        // if this chunk was manually placed and thus not in the pool, destroy it instead
        if (!_manualPlaced)
            Pool.Release((ChunkController_Old)this);
        else
