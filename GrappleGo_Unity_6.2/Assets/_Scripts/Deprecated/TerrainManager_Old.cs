...
public class TerrainManager_Old : MonoBehaviour
{
    ...
    // pool of chunks
    private IObjectPool<ChunkController_Old> _pool;

    // property referencing private pool
    public IObjectPool<ChunkController_Old> Pool
    {
        get
        {
            if (_pool == null)
            {
                _pool = new ObjectPool<ChunkController_Old>(CreatedPooledItem, OnTakeFromPool,
    ...
    private ChunkController_Old CreatedPooledItem()
    {
        ...
        if (chunkList.Count > 0)
        {
            ...
            ChunkController_Old chunkController = chunk.GetComponent<ChunkController_Old>();
    ...
    private void OnTakeFromPool(ChunkController_Old chunk)
    {
    ...
    private void OnReturnedFromPool(ChunkController_Old chunk)
    {
    ...
    private void OnDestroyPoolObject(ChunkController_Old chunk)
    {
